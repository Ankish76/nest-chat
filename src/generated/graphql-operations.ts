...
export type ChatFragmentFragment = { __typename?: 'Chat', id: string, message: string, type: string, createdAt: Date, updatedAt: Date };
...
export type AddMessageMutation = { __typename?: 'Mutation', addMessage: { __typename?: 'Chat', id: string, message: string, type: string, createdAt: Date, updatedAt: Date } };
...
export type ChatsQuery = { __typename?: 'Query', chats: { __typename?: 'QueryChatsConnection', totalCount: number, edges: Array<{ __typename?: 'QueryChatsConnectionEdge', node: { __typename?: 'Chat', id: string, message: string, type: string, createdAt: Date, updatedAt: Date } } | null>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } };
...
export type ChatSubSubscription = { __typename?: 'Subscription', chatSub: { __typename?: 'Chat', id: string, message: string, type: string, createdAt: Date, updatedAt: Date } };

export type ChatRoomFragmentFragment = { __typename?: 'ChatRoom', id: string, name: string, haveJoined: boolean, createdAt: Date, updatedAt: Date };
...
export type CreateRoomMutation = { __typename?: 'Mutation', createRoom: { __typename?: 'ChatRoom', id: string, name: string, haveJoined: boolean, createdAt: Date, updatedAt: Date } };
...
export type RoomsQuery = { __typename?: 'Query', rooms: { __typename?: 'QueryRoomsConnection', totalCount: number, edges: Array<{ __typename?: 'QueryRoomsConnectionEdge', node: { __typename?: 'ChatRoom', id: string, name: string, haveJoined: boolean, createdAt: Date, updatedAt: Date } } | null>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } };
...
export type UserFragmentFragment = { __typename?: 'User', id: string, name: string, createdAt: Date, updatedAt: Date };
...
export type JoinRoomMutation = { __typename?: 'Mutation', joinRoom: { __typename?: 'User', id: string, name: string, createdAt: Date, updatedAt: Date } };

export type SessionUserQueryVariables = Exact<{ [key: string]: never; }>;


export type SessionUserQuery = { __typename?: 'Query', sessionUser?: { __typename?: 'User', id: string, name: string, createdAt: Date, updatedAt: Date } | null };
...
export type UsersQuery = { __typename?: 'Query', users: { __typename?: 'QueryUsersConnection', totalCount: number, edges: Array<{ __typename?: 'QueryUsersConnectionEdge', node: { __typename?: 'User', id: string, name: string, createdAt: Date, updatedAt: Date } } | null>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null } } };
